#line 1 "C:/Users/BLAGI/Desktop/4a/MIKS/pid/MyProject.c"
...
float kd=0;
int count=0;
float v1=0.0,v_zeljeno=100.0,greska,greska_prije=0,greska_izvod=0,izvod=0,pom;
...
void interrupt()
{
 ...
 pom=(greska*kp+(greska_prije*ki)+kd*greska_izvod);
